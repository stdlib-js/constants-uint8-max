...
```javascript
UINT8_MAX = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-uint8-max@v0.2.3-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/constants-uint8-max@v0.2.3-umd/browser.js"></script>
```
